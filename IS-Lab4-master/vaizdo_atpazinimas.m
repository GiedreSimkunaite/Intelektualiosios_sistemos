...
% Create an feed-forward backpropagation network for classification with 13 neurons, and sigma = 1
hidden_neurons = 10; % 13 % neurons count
tinklas = newff(P,T,hidden_neurons);

%% Test of the feed-forward backpropagation network (recognizer)
